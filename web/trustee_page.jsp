		...
		<div class="container">
			<div class="row">
				...
				<h1 style="font-size: 30px;color:whitesmoke; font-family: Times New Roman, Times, serif" >Secure and Effective File Sharing with two factor Authentication</h1>
					<nav>
						<ul class="sf-menu">
							<li class="current"><a href="authority_page.jsp">Trustee Home</a>
...
<section id="content"  style="background-color:black">
	<div class="full-width-container block-2">
		<div class="container">
                    <br>		<!-- /Article -->
                    <center><h1 style="color:blue"><span>TRUSTEE HOME</span></h1></center>
                                ...
                                <center>
                                <header>
						<h2 style="color:whitesmoke"><span> Welcome! Trustee</span></h2>
					</header>
