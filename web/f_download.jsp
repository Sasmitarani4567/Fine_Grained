...
<section id="content"  style="background-color:black">
	<div class="full-width-container block-2">
		<div class="container">
			   ...
			   <center>
                               <table border="8" width="1000px" hieght="1200px" style="text-align: center;background-color:grey">
...
String mail=user.getAttribute("email").toString(); 
            ...
            %>
                                ...
                                <td style="font-size:18px;font:bolder"><%=rs.getString("size")%></td>
                                 ...
                                 <td style="font-size:18px;font:bolder;color:whitesmoke"><a href="downloadvcv.jsp?fname=<%=rs.getString("file_name")%>&mail=<%=mail%>" >Download</a> </td>
                               </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
