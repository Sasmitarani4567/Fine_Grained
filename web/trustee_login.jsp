				...
				<h1 style="font-size: 30px;color:whitesmoke; font-family: Times New Roman, Times, serif" >Secure and Effective File Sharing with two factor Authentication</h1>
					<nav>
						<ul class="sf-menu">
							...
							<li class="current"><a href="trustee_login.jsp">Trustee</a></li>
			...
			<div class="row">
			 <div  style="height: 300px; width: 1000px; margin-left: 10px;margin-bottom: -10px;">
                         <div style="width:500px;height: 300px;border-top-left-radius: 19px;border-bottom-left-radius: 19px;float: left;">
                             ...
                             <fieldset style="background-color:#ff9999;border-radius: 9px;height: 350px;margin-top: 10px;">
                                 <br>
          <center>
        <h1 style="font: monospace;font-size: 35px;font-weight: bold;color:black">Trustee Login</h1><br><br>
            <form action="trustee_login" name="" method="post" > 
<label style="font-size: 20px;margin-left:30px;">Trustee-ID:</label> <br><input type="text" id="id"  style="height: 30px; width:250px; " name="name"required style="margin-left: 45px;" placeholder="Enter Trustee ID "/><br><br>
...
<input type="reset" value="Reset" style="border-radius: 12px;height: 38px;width: 83px;background-color:slateblue"></input><br></br>
                                       ...
                                       <div style="height: 350px; width: 500px;margin-left:600px; background-image: url('images/trust.jpg')">
                                       </div>
                                 </div>
